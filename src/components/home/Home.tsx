    ...
    return (
        <div className="flex-col justify-center  max-w-fit ml-4 mr-4">
            <div className="mt-20 text-center"> 
                <h3 className="mt-2  underline  mb-6 text-center"> What is Divide and Conquer? </h3>
                ...
                <h3 className="mt-2  underline  mb-6 text-center">Why Use Divide and Conquer?</h3>
                ...
                <div className="flex items-center">
                    ...
                    <p><strong>Simplicity:</strong> Complex problems can be simplified by breaking them down recursively.</p>
                        ...
                        {/* Examples */}
                <h3 className="mt-2 underline  mb-6 text-center" >Examples of Divide and Conquer Algorithms</h3>

                <div className="p-4 rounded-lg shadow-lg border-l-5 border-blue-500 mb-6">
            ...
            <div className="p-4 rounded-lg shadow-lg border-l-5 border-yellow-500 mb-6">
                <div className="flex items-center mb-2">
                    <MagnifyingGlass className="w-6 h-6 text-yellow-500 mr-2" />
                    <h4 className="text-xl">Binary Search</h4>
                </div>
            ...
            <div className="p-4 rounded-lg shadow-lg border-l-5 border-green-500 mb-6">
                <div className="flex items-center mb-2">
                    <ChartBar className="w-6 h-6 text-green-500 mr-2"/>
                    <h4 className="text-xl">Quick Sort</h4>
                </div>
            ...
            <div className="p-4 rounded-lg shadow-lg border-l-5 border-red-500 mb-6">
                <div className="flex items-center mb-2">
                    <SquaresFour  className="w-6 h-6 text-red-500 mr-2" />
                    <h4 className="text-xl">Strassen Matrix</h4>
                </div>
                    ...
                    {/* Challenges */}
             <h3 className="mt-2 underline  mb-6 text-center">Some Challenges</h3>
                <div className="space-y-4">
                <div className="flex items-center">
        ...
        <h3 className="mt-2 underline  mb-6 text-center">Real-World Applications</h3>
                <div className="space-y-4">
                <div className="flex items-center">
