...
export const MERGE_SORT_STEPS  = [
    ...
    },
    {
      ...
      explanation: "Taking the smallest element from the left subarray and comparing with first element in right subarray.",
    ...
    },
    {
      ...
      explanation: "Taking the next smallest element from the left subarray and comparing with first element in right subarray.",
    ...
    },
    {
      ...
      explanation: "Taking the smallest elements from the left subarray and comparing with first element in right subarray.",
...
export const FULL_STEPS  = [
  ...
  },
  {
    ...
    explanation: "",
    splits: [[2], [1], [7], [6], [9], [5], [3]], 
    highlight: [0,1,2,3,4,5,6], // No specific highlight since it's the final state
  },
  {
    description: "Compare 2 and 1.",
    explanation: "We compare the two elements to determine their order.",
