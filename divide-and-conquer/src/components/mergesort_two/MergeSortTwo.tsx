  ...
  return (
    ...
    <div className="flex-col justify-center max-w-fit ml-4 mr-4 pb-12">
      <div className="mt-16 text-center">
        <h3 className="mt-3 mb-6 text-center"> Merge Sort CurrentStep </h3>
